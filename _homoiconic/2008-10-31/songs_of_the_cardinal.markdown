...
What does this mean? Let's compare it to the [thrush](http://braythwayt.com/homoiconic/2008-10-30/thrush.html#readme). The thrush is written `Txy = yx`. In Ruby terms,
...
* [cardinal.rb](http://braythwayt.com/homoiconic/2008-10-31/cardinal.rb)

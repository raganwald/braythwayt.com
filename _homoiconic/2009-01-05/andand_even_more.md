...
In other words, it's a [Quirky Bird](http://braythwayt.com/homoiconic/2008-11-04/quirky_birds_and_meta_syntactic_programming.html "Quirky Birds and Meta-Syntactic Programming"). But did you know that you can also use it to conditionally invoke a block? 
...
It's not just a Quirky Bird, it's also a [Cardinal](http://braythwayt.com/homoiconic/2008-10-31/songs_of_the_cardinal.html "Songs of the Cardinal").
...
Another problem is that we are obviously creating `my_var` just to use inside the block, but we're declaring it in top-level scope. We could fool around with a [Thrush](http://braythwayt.com/homoiconic/2008-10-30/thrush.html "The Thrush") like `let`, but instead let's use `Object#andand`:

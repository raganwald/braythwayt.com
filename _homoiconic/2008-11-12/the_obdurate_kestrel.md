...
In [Kestrels](http://braythwayt.com/homoiconic/2008-10-29/kestrel.html#readme), we looked at `#tap` from Ruby 1.9 and `returning` from Ruby on Rails. Today we're going to look at another use for `tap`.

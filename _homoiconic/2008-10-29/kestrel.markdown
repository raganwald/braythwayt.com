...
* [inside.rb](http://braythwayt.com/homoiconic/2008-10-29/inside.rb): If you are using Rails, drop it in `config/initializers` to make it available in your project.
* [You keep using that idiom](http://braythwayt.com/homoiconic/2008-10-29/you_keep_using_that_idiom.html#readme). I do not think it means what you think it means.

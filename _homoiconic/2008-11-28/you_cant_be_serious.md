...
In [Practical Recursive Combinators](http://braythwayt.com/homoiconic/2008-11-26/practical_recursive_combinators.html#readme), we enhanced `multirec` (a/k/a "Divide and Conquer") and `linrec` ("Linear Recursion") to accept as arguments any object that supports the `#to_proc` method. Today we're going demonstrate why: We will look at how removing the ceremony around lambdas makes using combinators like `multirec` more valuable for code we share with others.

Using [recursive\_combinators.rb](http://braythwayt.com/homoiconic/2008-11-26/recursive_combinators.rb) to define how to sum the squares of a nested list of numbers, we can write:
...
* [recursive\_combinators.rb](http://braythwayt.com/homoiconic/2008-11-26/recursive_combinators.rb)
* [string\_to\_proc.rb](http://braythwayt.com/homoiconic/2008-11-26/string_to_proc.rb)

_More on recursive combinators_: [Refactoring Methods with Recursive Combinators](http://braythwayt.com/homoiconic/2008-11-23/recursive_combinators.html#readme), and [Practical Recursive Combinators](http://braythwayt.com/homoiconic/2008-11-26/practical_recursive_combinators.html#readme).

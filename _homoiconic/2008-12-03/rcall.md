...
We could use one of our existing [recursive combinators](http://braythwayt.com/homoiconic/2008-11-26/practical_recursive_combinators.html#readme) like `linrec`:
...
If you've been following along with the techniques in [Practical Recursive Combinators](http://braythwayt.com/homoiconic/2008-11-26/practical_recursive_combinators.html#readme) and [Keep Your Privates To Yourself](http://braythwayt.com/homoiconic/2008-12-1/keep_your_privates_to_yourself.html#readme), you may have noticed that our implementation of `#rcall` naively creates a new lambda every time it is called. There are ways to fix this. Why not fork homoiconic and optimize `Proc#rcall` for yourself? Send me a pull request when you're done!

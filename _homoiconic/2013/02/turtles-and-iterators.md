...
(These code examples are in CoffeeScript. [Click here](./turtles-and-iterators.js.html#tortoises-teleporting-turtles-and-iterators) for code examples in JavaScript.)

...
Many--possibly most--stars are created from the very beginning as [binary] systems, with two or more sibling stars rotating around a common barycenter. One or more of these stars may supernova, leaving behind neutron stars in close proximity to each other. Binary systems containing neutron stars and even black holes have been discovered. In 1974, Russell Alan Hulse and Joseph Hooton Taylor discovered a binary system contining two neutron stars, now called the [Hulse–Taylor Binary] after them.

[binary]: https://en.wikipedia.org/wiki/Binary_star
[Hulse–Taylor Binary]: https://en.wikipedia.org/wiki/Hulse–Taylor_binary

One of the two neutron stars was acting as a [pulsar], but its pulses were arriving in an odd byut regular pattern: sometimes a little ahead of schedule, sometimes a little behind. From this, Hulse and Taylor determined that the pulsar was in a binary neutron star system, and the variation in pulses could be explained by the pulsar's movement in its orbit.

More interestingly, the [Hulse–Taylor Binary]'s orbits are slowly decaying. As the two neutron stars roatate around their common barycentre, gravity waves are given off. The waves carry energy with them, and the loss of energy is causing the orbits to [decay][Orbital decay]. Eventually, of course, the size of the orbits will be smaller than the diameter of the neutron stars, and they will collide. In the case of the Hulse-Taylor Binary, this could be as soon as 300 million years from now.

[Orbital decay]: https://en.wikipedia.org/wiki/Orbital_decay

When supermassive objects like neutron stars collide, a massive [gravitational wave] is created. Gravitational waves were first proposed by Henri Poincaré in 1905, but most people associate them with Albert Einstein, who predicted them ten years later within the framework of his [General Theory of Relativity], one of the great human intellectual achievements. Humans have been looking for evidence of gravitational waves ever since, but it was almost exactly 100 years later, in 2015, that we detected them, and the results were announced in early 2016.

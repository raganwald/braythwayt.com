...
Consider our neutron star. When it went supernova, it may already have had another neutron star as a sibling. As the two neutron stars orbit, they will also emit gravity waves, and their orbits will decay just like the Hulse-Taylor Binary. Eventually, of course, the size of the orbits will be smaller than the diameter of the neutron stars, and they will collide.

When supermassive objects like neutron stars collide, massive [gravitational wave] is created, much more massive than the waves created by the decaying orbits.
